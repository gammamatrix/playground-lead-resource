<fieldset class="mb-3">
    ...
    <x-playground::forms.column column="campaign_type" label="Campaign Type" :rules="['maxlength' => 255]" />

    @if (!empty($parents))
    <x-playground::forms.column-select column="parent_id" key="label" label="Parent Campaign" :records="$parents"/>
    @endif
