<fieldset class="mb-3">
    ...
    <x-playground::forms.column column="opportunity_type" label="Opportunity Type" :rules="['maxlength' => 255]" />

    @if (!empty($parents))
    <x-playground::forms.column-select column="parent_id" key="label" label="Parent Opportunity" :records="$parents"/>
    @endif
