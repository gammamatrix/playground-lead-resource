<fieldset class="mb-3">
    ...
    <x-playground::forms.column column="plan_type" label="Plan Type" :rules="['maxlength' => 255]" />

    @if (!empty($parents))
    <x-playground::forms.column-select column="parent_id" key="label" label="Parent Plan" :records="$parents"/>
    @endif
