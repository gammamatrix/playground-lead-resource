                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <small class="text-muted">
                            campaigns, goals, leads, opportunities, plans,
                            regions, reports, sources, tasks, teams and
                            teammates
                        </small>
                    </div>
                    <ul class="list-group list-group-flush">
                        @if ($viewCampaigns)
                            <a
                                href="{{ route("playground.lead.resource.campaigns") }}"
                        ...
                        @if ($viewGoals)
                            <a
                                href="{{ route("playground.lead.resource.goals") }}"
                                class="list-group-item list-group-item-action"
                            >
                                Goals
                            </a>
                        ...
                        @if ($viewLeads)
                            <a
                                href="{{ route("playground.lead.resource.leads") }}"
                                class="list-group-item list-group-item-action"
                            >
                                Leads
                            </a>
                        ...
                        @if ($viewOpportunities)
                            <a
                                href="{{ route("playground.lead.resource.opportunities") }}"
                                class="list-group-item list-group-item-action"
                            >
                                Opportunities
                            </a>
                        ...
                        @if ($viewPlans)
                            <a
                                href="{{ route("playground.lead.resource.plans") }}"
                                class="list-group-item list-group-item-action"
                            >
                                Plans
                            </a>
                        ...
                        @if ($viewRegions)
                            <a
                                href="{{ route("playground.lead.resource.regions") }}"
                                class="list-group-item list-group-item-action"
                            >
                                Regions
                            </a>
                        ...
                        @if ($viewReports)
                            <a
                                href="{{ route("playground.lead.resource.reports") }}"
                                class="list-group-item list-group-item-action"
                            >
                                Reports
                            </a>
                        ...
                        @if ($viewSources)
                            <a
                                href="{{ route("playground.lead.resource.sources") }}"
                                class="list-group-item list-group-item-action"
                            >
                                Sources
                            </a>
                        ...
                        @if ($viewTasks)
                            <a
                                href="{{ route("playground.lead.resource.tasks") }}"
                                class="list-group-item list-group-item-action"
                            >
                                Tasks
                            </a>
                        ...
                        @if ($viewTeams)
                            <a
                                href="{{ route("playground.lead.resource.teams") }}"
                                class="list-group-item list-group-item-action"
                            >
                                Teams
                            </a>
                        ...
                        @if ($viewTeammates)
                            <a
                                href="{{ route("playground.lead.resource.teammates") }}"
                                class="list-group-item list-group-item-action"
                            >
                                Teammates
                            </a>
