<fieldset class="mb-3">
    ...
    <x-playground::forms.column column="goal_type" label="Goal Type" :rules="['maxlength' => 255]" />

    @if (!empty($parents))
    <x-playground::forms.column-select column="parent_id" key="label" label="Parent Goal" :records="$parents"/>
    @endif
