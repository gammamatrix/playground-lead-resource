<fieldset class="mb-3">
    ...
    <x-playground::forms.column column="region_type" label="Region Type" :rules="['maxlength' => 255]" />

    @if (!empty($parents))
    <x-playground::forms.column-select column="parent_id" key="label" label="Parent Region" :records="$parents"/>
    @endif
