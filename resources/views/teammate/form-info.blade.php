<fieldset class="mb-3">
    ...
    <x-playground::forms.column column="teammate_type" label="Teammate Type" :rules="['maxlength' => 255]" />

    @if (!empty($parents))
    <x-playground::forms.column-select column="parent_id" key="label" label="Parent Teammate" :records="$parents"/>
    @endif
